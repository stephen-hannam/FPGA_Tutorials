...
add wave -noupdate /typische_tb/clk_tb
add wave -noupdate -radix unsigned /typische_tb/a_cnt
add wave -noupdate -radix unsigned /typische_tb/b_cnt
add wave -noupdate /typische_tb/b_locked
add wave -noupdate /typische_tb/a_locked
...
add wave -noupdate /typische_tb/a_done
add wave -noupdate /typische_tb/b_done
...
WaveRestoreCursors {{Cursor 1} {25552 ps} 0}
